...
struct bej_node {
    ...
    unsigned int child_pointer_offset;   ///< Offset of an element in a dictionary
...
int get_child_pointer_offset_dictionary (struct bej_node *node, 
...
struct bej_node* parse_sflv_recursion(struct bej_node *parent, unsigned char **data, 
									size_t data_len,unsigned char *schema_dictionary);
